...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QLabel, QSlider, QMessageBox, QFrame, QSizePolicy, QComboBox,
...
from viewer_components import ColorStripWidget, TrajectoryTestThread
...
class RobotPathViewer(ViewerProjectMixin, ViewerIOMixin, QMainWindow):
